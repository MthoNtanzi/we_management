...
<div class="py-3">
    <h2 class="display-5 text-center py-6 text-capitalize">
        ...
        <div class="founder-section d-flex flex-md-row flex-column">
            ...
            <div class="col-md-7 founder-content">
                ...
                <div class="founder-social mb-4">
                    <a href="<?php echo esc_url(get_theme_mod('founder_linkedin', 'https://www.linkedin.com/in/jessicaalvarezcre/')); ?>"><i class="fab fa-linkedin-in"></i></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="owl-carousel partner-carousel wow fadeInUp" data-wow-delay="0.3s">
                <div class="partner-item text-center p-4">
                    <a href="https://crewftlbr.org/" target="_blank" rel="noopener">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/partners/crew.jpg" class="partner-logo" alt="CREW Fort Lauderdale">
                    </a>
                </div>
                <div class="partner-item text-center p-4">
                    <a href="https://www.csimoldspecialist.com/" target="_blank" rel="noopener">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/partners/CSI-Mold-Specialist-logo.png" class="partner-logo" alt="CSI Mold Specialist">
                    </a>
                </div>
                <div class="partner-item text-center p-4">
                    <a href="https://www.bomamiamidade.org/" target="_blank" rel="noopener">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/partners/boma-miami-logo.jpg" class="partner-logo" alt="BOMA Miami">
                    </a>
                </div>
                <div class="partner-item text-center p-4">
                    <a href="https://www.cpc-tx.com/" target="_blank" rel="noopener">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/partners/CPC_Logo.png" class="partner-logo" alt="Claremont">
                    </a>
                </div>
                <div class="partner-item text-center p-4">
                    <a href="https://www.bankofamerica.com" target="_blank" rel="noopener">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/partners/boa.svg" class="partner-logo" alt="Bank of America">
                    </a>
                </div>
            </div>
...
<?php get_template_part('template-parts/home', 'cta2'); ?>
