    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <p class="mb-4">
                    <?php echo esc_html(get_theme_mod('our_story_description', 'At WE Management Group, we bring unparalleled expertise in commercial real estate, combining years of experience in property management, leasing, and retail development...')); ?>
                </p>
...
<div class="py-3">
    ...
    <p style="max-width: 950px; margin: 20px auto 60px auto; text-align: center;">
        <?php echo esc_html(get_theme_mod('our_approach_description', 'We take a collaborative and personalized approach to property management...')); ?>
    </p>
    ...
    <div class="mb-4">
        ...
        <div class="image_and_service_desc">
            <p>
                <?php echo esc_html(get_theme_mod('our_approach_text', 'We pride ourselves on a proactive and transparent approach to property management...')); ?>
            </p>
            <img class="img-fluid"
        ...
        <div class="founder-section d-flex flex-md-row flex-column">
            ...
            <div class="col-md-7 founder-content">
                ...
                <div class="founder-quote mb-4">
                    <p>"<?php echo esc_html(get_theme_mod('founder_quote', 'Our success comes from treating every property as if it were our own...')); ?>"</p>
                </div>
